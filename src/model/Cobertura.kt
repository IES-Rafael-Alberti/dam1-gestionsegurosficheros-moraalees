...
enum class Cobertura(desc: String) {
    ...
    companion object{
        fun getCobertura(valor: String): Cobertura{
            if (valor.uppercase() == Cobertura.TERCEROS.toString()){
                return Cobertura.TERCEROS
            } else if (valor.uppercase() == Cobertura.TERCEROS_AMPLIADO.toString()){
                return Cobertura.TERCEROS_AMPLIADO
            } else if (valor.uppercase() == Cobertura.FRANQUICIA_200.toString()){
                return Cobertura.FRANQUICIA_200
            } else if (valor.uppercase() == Cobertura.FRANQUICIA_300.toString()){
                return Cobertura.FRANQUICIA_300
            } else if (valor.uppercase() == Cobertura.FRANQUICIA_400.toString()){
                return Cobertura.FRANQUICIA_400
            } else if (valor.uppercase() == Cobertura.FRANQUICIA_500.toString()){
                return Cobertura.FRANQUICIA_500
            } else if (valor.uppercase() == Cobertura.TODO_RIESGO.toString()){
